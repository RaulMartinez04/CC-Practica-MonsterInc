...
public abstract class Cheff extends Oficio {
     ...
     */
    public void preparar_comida(int id_del_platillo, AtomicInteger[] inventario, String nombre)
     ...
     */
    public Platillo[] get_lista_platillos() {
     ...
     */
    public void set_lista_platillos(Platillo[] lista_nueva) {
     ...
     */
    public void set_Inventario(AtomicInteger[] inventario, Platillo consumir) {
     ...
     */
    // Concurrente
    public void llenar_Inventario(AtomicInteger[] inventario, int a_llenar) {
